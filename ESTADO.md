...
- **DESPLIEGUE (directo a producción, a pedido del dueño):** la migración es backward-compatible → orden seguro = (1) el dueño aplica `008` en el SQL Editor, (2) `vercel deploy --prod`. El front/panel degradan a legacy si la migración aún no está, así ninguna ventana rompe la tienda en vivo.
- **PENDIENTE:** aplicar `008`; deploy prod + smoke test; el dueño carga colores reales y su stock, y sube guías; review visual en móvil.
